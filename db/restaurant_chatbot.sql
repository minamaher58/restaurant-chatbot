CREATE DATABASE IF NOT EXISTS `restaurant-chatbot` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
BEGIN
    ...
    VALUES (p_order_id, p_item_id, p_quantity, v_total_price);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
